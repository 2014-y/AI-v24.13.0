...
> 基于 OpenClaw 的本地 ClawAI 网关，一键部署，多渠道接入，开箱即用。

---

## 🌟 ClawAI-开源版 v1.0.9 深度优化亮点（最新更新）
...
* **文件名**：`ClawAI Setup x.x.x.exe` (如 `ClawAI Setup 1.0.9.exe`)

### 💿 2. 简易安装
1. 双击运行下载好的 `ClawAI Setup x.x.x.exe` 文件；
...
ClawAI 就是一个**本地 AI 助手网关**。它把你的电脑变成一个 24 小时在线的 AI 服务平台，然后通过微信、WhatsApp、Discord、飞书、Telegram 这些你每天都在用的聊天工具，直接跟 AI 对话。
...
| **访问控制** | 白名单管理 | 指定谁能用你的 ClawAI 助手，防止滥用 |
...
- **个人用户** — 想在自己的电脑上跑一个 ClawAI 助手，随时用微信聊天
